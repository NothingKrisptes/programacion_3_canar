// Segundo ejemplo: Icono de vehículo arrastrable que cambia de color según disponibilidad
const circulo = document.getElementById('circulo');
let colores = ['#0070f3', 'green', 'red', 'orange', 'purple', 'gray'];
let colorActual = 0;

let arrastrando = false;

// Cambiar color (simula cambio de estado del vehículo)
function cambiarColor() {
   colorActual = (colorActual + 1) % colores.length;
   circulo.style.background = colores[colorActual];
}

// Mover el icono al punto (centrado)
