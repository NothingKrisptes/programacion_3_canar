...
const RegisterSchema = z.object({
  ...
  birthYear: z.number({ error: 'Debe ser un número' })
    ...
    .max(new Date().getFullYear() - 18, 'Debes ser mayor de edad para rentar un vehículo'),
}).refine(
...
export default function ZodRegistrationForm_mp() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    console.log('Cliente registrado en Wheels To Go:', result.data)
    setSuccess(true)
  }
    ...
    >
      {success && (
        <div style={{ padding: 12, background: '#dcfce7', borderRadius: 6, color: '#166534' }}>
          ✅ Registro completado en Wheels To Go
        </div>
      )}
