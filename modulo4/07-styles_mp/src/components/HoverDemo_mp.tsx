...
import { useHover } from '../hooks/useHover_mp'
  ...
  return (
    <div {...card.hoverProps} style={card.style}>
      <h3 style={{ margin: '0 0 12px', color: 'var(--accent)', fontWeight: 800 }}>
        Hook useHover — Tarjeta de Vehículo Wheels To Go
      </h3>
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        <button {...btn1.hoverProps} style={btn1.style}>Reservar ahora</button>
        <button {...btn2.hoverProps} style={btn2.style}>Ver detalles</button>
      </div>
    </div>
  )
}
